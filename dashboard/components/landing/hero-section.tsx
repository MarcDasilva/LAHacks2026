...
export function HeroSection() {
  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center overflow-hidden">
      ...
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[600px] h-[600px] lg:w-[800px] lg:h-[800px] opacity-80 pointer-events-none">
        <AnimatedSphere />
      </div>
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        <div className="mb-12">
          <h1
            className={`text-[clamp(3rem,12vw,10rem)] text-black font-display leading-[0.9] tracking-tight transition-all duration-1000 ${
              isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
            }`}
          >
            <span className="block">
              EMT <span className="font-bold">OS</span>
            </span>
            <span className="block">
              to{" "}
              <span className="relative inline-block">
                ...
                <span className="absolute -bottom-2 left-0 right-0 h-3 bg-white/35" />
              </span>
            </span>
          </h1>
        </div>
