...
const codeExamples = [
  {
    label: "Install",
    code: `npm install @impulse/sdk

# or
yarn add @impulse/sdk
pnpm add @impulse/sdk`,
  },
  {
    label: "Initialize",
    code: `import { IMPULSE } from '@impulse/sdk'

const impulse = new IMPULSE({
  apiKey: process.env.IMPULSE_KEY
})`,
  },
  {
    label: "Deploy",
    code: `const app = await impulse.deploy({
  name: 'my-app',
  region: 'auto',
  scaling: {
    min: 1,
