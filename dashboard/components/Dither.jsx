...
void main() {
  ...
  vec2 scrollOffset = vec2(0.0, scrollY);
  float f = pattern(uv + scrollOffset);
...
function DitheredWaves({
  ...
  useFrame(() => {
    ...
    if (typeof window !== 'undefined') {
      const normalizedScroll = (window.scrollY || 0) / Math.max(u.resolution.value.y, 1);
      u.scrollY.value = normalizedScroll * 4.0;
    } else {
      u.scrollY.value = 0;
    }
